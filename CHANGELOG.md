...
## [v0.9.0](https://github.com/mackerelio-labs/mcp-server/compare/v0.8.0...v0.9.0) - 2026-09-11
...
- build(deps): bump fast-uri from 3.1.2 to 3.1.4 by @dependabot[bot] in https://github.com/mackerelio-labs/mcp-server/pull/98
...
- build(deps): bump hono from 4.12.14 to 4.12.18 by @dependabot[bot] in https://github.com/mackerelio-labs/mcp-server/pull/84
- build(deps): bump fast-uri from 3.1.0 to 3.1.2 by @dependabot[bot] in https://github.com/mackerelio-labs/mcp-server/pull/85
- build(deps-dev): bump postcss from 8.5.6 to 8.5.14 by @dependabot[bot] in https://github.com/mackerelio-labs/mcp-server/pull/86
- ignore-scripts=true by @azukiazusa1 in https://github.com/mackerelio-labs/mcp-server/pull/83
- build(deps): bump ip-address and express-rate-limit by @dependabot[bot] in https://github.com/mackerelio-labs/mcp-server/pull/82
- Add min-release-age setting to .npmrc by @tjmtmmnk in https://github.com/mackerelio-labs/mcp-server/pull/87
